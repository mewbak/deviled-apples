...
int32_t function_6dba8(int32_t a1, int32_t a2, int32_t a3, int32_t a4)
{
	...
	*(int32_t *)v9 = v8;
	...
	if (v10 < 1) {
		...
		*v13 = v14 / 2 | v14 & -0x80000000;
		...
		g41 = 16;
		GetMissileVel();
		v16 = function_6dba8(a2, a3, v1, g32);
		SetMissDir(a1, v16);
		v15 = g35 + g36;
		a1 = v15;
		*(int32_t *)(v15 + 116) = 256;
...
int32_t AddBoneSpirit(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7)
{
	...
	*(int32_t *)(180 * a1 + *(int32_t *)(g23 - 0x7664) + 128) = 0;
	...
	g41 = 16;
	GetMissileVel();
	SetMissDir(a1, function_6dba8(v1, v3, v2, v4));
	*(int32_t *)(g35 + 116) = 256;
	*(int32_t *)(g35 + 148) = v1;
	*(int32_t *)(g35 + 152) = v3;
	*(int32_t *)(g35 + 156) = g33;
	...
	while (true) {
		...
		if (*(char *)(v2 + 29) != 0) {
			...
			if (function_85a14(g28, g29, v5, *(int32_t *)(v2 + 68)) != 0) {
				...
				function_73f28(0, 0, *(int32_t *)(v6 + 64), v7, 0, 66, g30, g32, 0);
				// branch -> 0x73eec
			}
			// 0x73eec
			v3 = g35 + 0x55ec;
...
int32_t function_73f28(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6, int32_t a7, int32_t a8, int32_t a9)
{
...
int32_t function_74170(int32_t a1, int32_t a2, int32_t a3)
{
	...
	*(int32_t *)(v10 + 156) = *(int32_t *)*(int32_t *)(g23 - 0x7150);
	...
	g13 = *(int32_t *)(v10 + 120);
	function_73f28(*(int32_t *)g32, v13, g29, g30, v9, 1, 0, v12, v11);
	g31 = -1;
	v4 = -1;
	// branch -> 0x74270
	// 0x74270
		...
		if (*(int32_t *)(v10 + 124) != 0) {
			...
			*(int32_t *)g26 = g21;
			...
			if (v30 == 24) {
				...
				v39 = *(int32_t *)(v31 + 44);
				g13 = *(int32_t *)g24;
				function_73f28(*(int32_t *)g30, v38, g36, 0, v39, 25, 0x1000000 * v37 / 0x1000000, 0, 0);
				// branch -> 0x74cb4
				// 0x74cb4
						...
						*(int32_t *)v29 = 0;
						...
						if (v30 <= 63) {
							...
							if (v30 == 57) {
								...
								v45 = *(int32_t *)(v33 + 44);
								g13 = *(int32_t *)g24;
								function_73f28(*(int32_t *)g30, v44, g36, 0, v45, 58, 0x1000000 * v43 / 0x1000000, 0, 0);
								// branch -> 0x74cb4
							}
						}
						// 0x74cb4
				...
				if (v30 == 21) {
					...
					v42 = *(int32_t *)(v32 + 44);
					g13 = *(int32_t *)g24;
					function_73f28(*(int32_t *)g30, v41, g36, 0, v42, 9, 0x1000000 * v40 / 0x1000000, 0, 0);
					// branch -> 0x74cb4
				} else {
					// 0x74bb0
					if (v30 <= 21) {
							...
							if (v15 <= 111) {
								...
								if (v16 <= 111) {
									...
									if (v25 == -1) {
										...
										v32 = *(int32_t *)v12;
										v46 = *(int32_t *)(v24 + 32);
										function_73f28(v31, v32, v45, v46, a1, 8, 0x1000000 * v44 / 0x1000000, v4, v43);
										// branch -> 0x75abc
									} else {
										// 0x759f4
										v36 = *(int32_t *)(v24 + 124);
										if (v36 == 1) {
											...
											if (v26 >= 76) {
												...
												if (v26 <= 79) {
													...
													v28 = *(int32_t *)v12;
													v39 = *(int32_t *)(v24 + 32);
													function_73f28(v27, v28, v38, v39, a1, 23, 1, v4, v37);
													// branch -> 0x75abc
													// 0x75abc
													result = g31 + g35;
										...
										v30 = *(int32_t *)v12;
										v42 = *(int32_t *)(v24 + 32);
										function_73f28(v29, v30, v41, v42, a1, 8, 0x1000000 * v36 / 0x1000000, v4, v40);
										// branch -> 0x75abc
									}
									// 0x75abc
									result = g31 + g35;
...
int32_t function_769f8(int32_t a1)
{
	// 0x769f8
	g36 = *(int32_t *)(g23 - 0x70e0);
	int32_t v1 = 9;                              // ctr
		...
		*(int32_t *)(v3 + 12) = *(int32_t *)(v4 + 12);
		...
		if (v8 == 0) {
			...
			*(int32_t *)(v7 + 8) = *(int32_t *)(v6 + 8);
			...
			function_73f28(v12, v13, *(int32_t *)v10, v17, v14, 7, 0, 1, v16);
									...
									if (v33 >= 1) {
										...
										if (v33 <= 111) {
											...
											if (*(int16_t *)(*(int32_t *)g35 + 2 * v33 + 224 * v31) >= 1) {
												...
												g13 = g26;
												function_73f28(g28, g27, v35, v34, v38, 7, 0, 1, v39);
												v36 = g24;
												v37 = g32;
												// branch -> 0x76b80
											} else {
	...
	*v8 = *v8 - 1;
	...
	if (*(int32_t *)v4 == 0) {
		...
		*(int32_t *)(v9 + 52) = 1;
		...
		result = function_73f28(v15, v16, g34, 0, v17, 59, 1, v12, v14);
		// branch -> 0x7700c
	} else {
		// 0x77008
		result = PutMissile();
					...
					if (v11 <= 111) {
						...
						if (v12 >= 1) {
							...
							if (v12 <= 111) {
								...
								function_73f28(v7, v8, v23, 5, 0, 5, 0, (int32_t)&v22, (int32_t)&v22);
								*(int32_t *)g27 = g25;
								*(int32_t *)g26 = g24;
								// branch -> 0x778cc
								// 0x778cc
											...
											if (v15 <= 111) {
												...
												if (v16 >= 1) {
													...
													if (v16 <= 111) {
														...
														result = function_73f28(v18, v19, v20, 5, 0, 5, 0, (int32_t)&v22, (int32_t)&v22);
														*(int32_t *)g26 = g24;
														*(int32_t *)g27 = g25;
														// branch -> 0x77990
														// 0x77990
					...
					if (v21 == 0) {
						...
						if (*(int16_t *)(v24 + *(int32_t *)g32 + v14) >= 4) {
							...
							if (*(char *)(g35 + (int32_t)v31) == 0) {
								...
								function_73f28(v13, v32, v13, v32, v33, 36, 0, *(int32_t *)(v20 + 128), 0);
								v5 = 1;
								v25 = 1;
								v26 = 1;
								v27 = g36;
...
int32_t function_77b58(int32_t a1)
{
	// 0x77b58
	g21 = 0;
	...
	if (*(char *)(*(int32_t *)(g23 - 0x7234) + (int32_t)v14) == 0) {
		...
		g13 = v7;
		function_73f28(v12, v13, v12 + v10, v13 + v11, v16, 14, 0, 0, v15);
							...
							if (v29 <= 111) {
								...
								if (v31 >= 1) {
									...
									if (v31 <= 111) {
										...
										function_73f28(v29, v31, v39 + v29, v40 + v31, v41, 14, 0, 0, v28);
										g35 += *(int32_t *)g18;
										g36 += *(int32_t *)g19;
										v35 = g32;
										v37 = g33;
													...
													if (v35 <= 111) {
														...
														if (v37 >= 1) {
															...
															if (v37 <= 111) {
																...
																function_73f28(v35, v37, v46 + v35, v47 + v37, v48, 14, 0, 0, v45);
																v43 = g32 + *(int32_t *)g17;
																v44 = g33 + *(int32_t *)g20;
																// branch -> 0x77dcc
															lab_0x77dcc:;
	...
	while (true) {
		...
		if (v9 == v11) {
			...
			if (v8 != (int32_t)*v12) {
				...
				v30 = *(int32_t *)(g28 + 48);
				g13 = g36;
				function_73f28(v15, v16, v15 + v11, v16 + (int32_t)v29, g32, 4, 0x1000000 * g31 / 0x1000000, g30, v30);
				v17 = g29;
				v31 = *(char *)(v17 + 6);
				v18 = g35;
				v32 = *(char *)(v17 + 7);
				...
				g13 = g36;
				v33 = *(int32_t *)(g28 + 48);
				function_73f28(v18, v19, v18 - (int32_t)v31, v19 - (int32_t)v32, g32, 4, 0x1000000 * g31 / 0x1000000, g30, v33);
				v20 = g29;
				v34 = *(char *)(v20 + 6);
				v21 = g35;
				v35 = *(char *)(v20 + 7);
				...
				g13 = g36;
				v36 = *(int32_t *)(g28 + 48);
				function_73f28(v21, v22, v21 - (int32_t)v34, v22 + (int32_t)v35, g32, 4, 0x1000000 * g31 / 0x1000000, g30, v36);
				v23 = g29;
				v37 = *(char *)(v23 + 6);
				v24 = g35;
				v38 = *(char *)(v23 + 7);
				...
				g13 = g36;
				v39 = *(int32_t *)(g28 + 48);
				function_73f28(v24, v25, v24 + (int32_t)v37, v25 - (int32_t)v38, g32, 4, 0x1000000 * g31 / 0x1000000, g30, v39);
				v26 = g29;
				v28 = v26;
				v27 = g26;
...
int32_t function_78118(int32_t a1)
{
	...
	*v8 = *(int32_t *)(v4 + 24) + *v8;
	...
	if (*(char *)((int32_t)v17 + *(int32_t *)(g23 - 0x7234)) == 0) {
		...
		function_73f28(v12, v16, v21, v22, v1, 48, 0x1000000 * v20 / 0x1000000, v18, v19);
		// branch -> 0x7820c
	} else {
		// 0x78204
		*(int32_t *)g32 = 0;
		...
		if (*v26 == 1) {
			...
			*(int32_t *)g30 = 255;
			...
			if (v32 < 1) {
				...
				int32_t v40 = function_6dba8(g29, g28, *(int32_t *)v38, *(int32_t *)v39); // 0x789dc
				SetMissDir(g25, v40);
				g39 = *(int32_t *)v38;
				g34 = g25;
				g40 = *(int32_t *)v39;
			...
			*(int32_t *)g31 = 255;
			...
			if (v20 < 1) {
				...
				*(int32_t *)g30 = *(int32_t *)(v25 + 152) / 128;
				...
				int32_t v28 = function_6dba8(g29, g28, *(int32_t *)(v25 + 32), v27); // 0x78c4c
				SetMissDir(g26, v28);
				g39 = *(int32_t *)g33;
				g34 = g26;
				g40 = *(int32_t *)v26;
