...
int32_t function_3d9f0(int32_t a1, int32_t a2)
{
	// 0x3d9f0
	g36 = a1;
...
int32_t function_3daf4(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5)
{
...
int32_t function_3dd98(int32_t a1, int32_t a2)
{
...
int32_t function_3de48(int32_t a1, int32_t a2)
{
...
int32_t function_3de70(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5)
{
...
int32_t CreateRoom(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5, int32_t a6)
{
	...
	if (v5 > v7) {
		...
		if (v9 > v38) {
			...
			// 0x3e10c
			function_3daf4(v19, v20, v21, v22, g24);
			if (g24 == 1) {
				// 0x3e12c
				v23 = g23;
			...
			*(int32_t *)(v4 + 20 * v46 + 16) = v24;
			...
			if (v24 != 0) {
				...
				// 0x3e2e4
				function_3de70(g18, g21, g27, v28, a6);
				v29 = g31;
				// branch -> 0x3e2fc
			}
			// 0x3e2fc
...
int32_t ConnectHall(int32_t a1, int32_t a2, int32_t a3, int32_t a4, int32_t a5)
{
	...
	g25 = v5;
	function_3dd98(v4, v5);
	int32_t v6 = a3; // 0x3e550
	function_3dd98(v6, a4);
	g34 = v6 - a1;
	abs();
	g34 = a4 - g21;
	abs();
...
int32_t function_3eb78(int32_t a1)
{
	int32_t v1 = 0;                          // r6
...
int32_t function_3fed4(int32_t a1)
{
	...
	while (true) {
		...
		*(int32_t *)*v2 = 0;
		...
		if (v4 != 0) {
			...
			if (*(int32_t *)g25 != 0) {
				// 0x4068c
				function_3d9f0(*(int32_t *)g36, *(int32_t *)g35);
				// branch -> 0x40698
			}
			// 0x40698
			function_3fed4(function_3c374(3));
