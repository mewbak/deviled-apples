			...
			if (*(int32_t *)(v12 + 220) == v35) {
				...
				*(int16_t *)(v31 + 2 * v37 + 224 * v36) = (int16_t)v30;
				...
				if (v32 <= 49) {
					...
					g13 = g32;
					v38 = *(int32_t *)(v27 + 36);
					result2 = function_73f28(*(int32_t *)(v27 + 32), v38, 0, 0, 0, 59, 1, v39 + 1, g36);
					// branch -> 0x7d4c8
				} else {
					result2 = result;
				}
...
int32_t M2MStartKill(int32_t a1, int32_t a2, int32_t a3)
{
	...
	*(int16_t *)(v28 + v29) = (int16_t)v27;
	...
	if (v30 <= 49) {
		...
		result2 = function_73f28(*(int32_t *)g32, v32, 0, 0, 0, 59, 1, v31 + 1, g36);
		// branch -> 0x7d770
	} else {
		result2 = result;
	}
	...
	if (*(int32_t *)v7 == (int32_t)v8) {
		...
		if (*(int32_t *)(v6 + 116) != -1) {
			...
			while (true) {
				...
				function_73f28(v12, v13, (int32_t)v14, (int32_t)v15, v16, v17, 1, v11, v10);
				if (g28 + 1 < g29) {
					// 0x7ebe4
					v10 = g35;
					v6 = g32;
...
int32_t function_7ec6c(int32_t a1)
{
	...
	if (v10 == (int32_t) * (char *)(*(int32_t *)(v8 + 228) + 110)) {
		...
		if (*(int32_t *)(v8 + 96) == 0) {
			...
			function_73f28(v14, v15, v16, (int32_t)v17, v18, v19, 1, v13, 0);
			PlayEffect(g32, 3);
			v11 = g35;
			v12 = g36;
			// branch -> 0x7ed54
			...
			if (abs() <= 2) {
				...
				if (function_85a54(*(int32_t *)(g23 - 0x70c4), g35, v20, v21, g33, v7) != 0) {
					...
					if (*(int32_t *)(v22 + 116) != 14) {
						...
						int32_t v25 = function_73f28(v23, v24, g33, g32, g29, 20, 0x1000000 * g28 / 0x1000000, 0, 0); // 0x80ea4
						result = v25;
						if (v25 != -1) {
							// 0x80eb0
							PlayEffect(g35, 0);
		...
		if (abs() > 4) {
			...
			if (g36 < 4 * (int32_t) * (char *)(v27 + 157) + 33) {
				...
				if (function_85a54(v32, g31, v33, v34, v11, v12) != 0) {
					...
					v35 = *(int32_t *)(v28 + 32);
					v36 = *(int32_t *)(v28 + 36);
					v38 = function_73f28(v35, v36, g28, g27, g33, 20, 0x1000000 * g32 / 0x1000000, 0, 0);
					result2 = v38;
					if (v38 != -1) {
						// 0x81228
						v29 = g35;
				...
				if (g36 < v17 + 8) {
					...
					*(int32_t *)(g35 + 12) = 0;
					...
					if (*(char *)v20 == 41) {
						...
						g13 = g31;
						v21 = *(char *)(g35 + 81);
						v26 = function_73f28(v14, (int32_t)v21, v14 + 1, 0, -1, 8, 1, v18, 0);
						result2 = v26;
						// branch -> 0x81358
					}
				}
...
int32_t function_819e8(int32_t result)
{
	...
	if (*(char *)(v5 + 164) != 0) {
		...
		if (function_85a14(*(int32_t *)(v9 + 32), v24, v6, g25) != 0) {
			...
			if (function_73f28(v26, v27, g26, g25, g30, 50, 0x1000000 * g27 / 0x1000000, 0, 0) != -1) {
				// 0x81ac4
				*(int32_t *)(g35 + 4) = 14;
				*(char *)(g35 + 8) = 5;
				*(int32_t *)(g35 + 12) = g28;
						...
						if (abs() > 4) {
							...
							if (g36 < 2 * (int32_t) * (char *)(v8 + 157) + 43) {
								...
								if (function_85a54(*(int32_t *)(g23 - 0x70c4), g28, v22, v23, g33, g32) != 0) {
									...
									v25 = *(int32_t *)(v9 + 32);
									v26 = *(int32_t *)(v9 + 36);
									v30 = function_73f28(v25, v26, g33, g32, g29, 20, 0x1000000 * v24 / 0x1000000, 0, 0);
									result = v30;
									if (v30 != -1) {
										// 0x83d8c
										v10 = g35;
						...
						if (abs() > 4) {
							...
							if (g36 < 2 * (int32_t) * (char *)(v8 + 157) + 43) {
								...
								if (function_85a54(*(int32_t *)(g23 - 0x70c4), g28, v22, v23, g33, g32) != 0) {
									...
									v25 = *(int32_t *)(v9 + 32);
									v26 = *(int32_t *)(v9 + 36);
									if (function_73f28(v25, v26, g33, g32, g29, 20, 0x1000000 * v24 / 0x1000000, 0, 0) != -1) {
										// 0x83d8c
										v10 = g35;
										v11 = v10;
										if (*(int32_t *)(*(int32_t *)(v10 + 228) + 20) != 0) {
					...
					*(int32_t *)(g35 + 72) = g29;
					...
					if (*(int32_t *)(v24 + 152) < (v25 / 2 || v25 & -0x80000000)) {
						...
						*(int32_t *)(g35 + 12) = 0;
						...
						function_73f28(*(int32_t *)(v28 + 32), v29, 0, 0, v30, 11, 1, 4, 0);
						g13 = g28;
						int32_t v31 = *(int32_t *)g27;                                                              // 0x841f4
						int32_t v32 = function_73f28(*(int32_t *)g32, *(int32_t *)g31, 0, 0, v31, 12, 1, g30, g29); // 0x841f8
						v13 = v32;
						// branch -> 0x842f0
					}
					// 0x842f0
